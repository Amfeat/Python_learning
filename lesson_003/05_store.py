...
total_price = 0  # цена всего что есть на складе
for good in goods:
    goods_price = 0  # цена всех товаров одного типа
    goods_quantity = 0  # количество всех товаров одного типа
    for models in store[goods[good]]:
        goods_quantity += models['quantity']
        goods_price += int(models['quantity']) * int(models['price'])
    print(f'{good} - {goods_quantity} шт, стоимость {goods_price} руб')
